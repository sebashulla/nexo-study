...
export function CoursePracticePage({ course, sessions, onPrepare, onComplete, onOpenActivity }: {
  ...
  onOpenActivity: (materialId: string, mode: MaterialStudyMode) => void
}) {
